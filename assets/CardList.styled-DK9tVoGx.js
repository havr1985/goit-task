import{f as Oe,r as $,u as g,h as Qe,i as et,g as tt,j as p,a as nt,b as ot,k as rt}from"./index-QjHlNaob.js";const De=t=>t.cars,Bn=Oe(De,t=>t.cars),at=Oe(De,t=>t.carsArr),st=t=>t.filters,qn=t=>t.cars.isLoading,lt=t=>t.favorite.favorite,$n=Oe([at,st],(t,e)=>{if(e.makeSelect&&e.priceSelect){let o=t.filter(r=>r.make===e.makeSelect);return o=o.filter(r=>r.rentalPrice.slice(1,10)===e.priceSelect),o}if(e.priceSelect)return t.filter(r=>r.rentalPrice.slice(1,10)===e.priceSelect);if(e.makeSelect)return t.filter(r=>r.make===e.makeSelect)});/**
